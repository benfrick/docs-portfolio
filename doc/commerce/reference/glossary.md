...
This guide provides a glossary of terms.
...
| **[Splunk](https://www.splunk.com/)** | Third party logging and monitoring tool for troubleshooting                                                                                                                                                                                                |
| **Trace ID**                          | A unique ID passed from API to API to track the path of a request and response                                                                                                                                                                     |
| **URI**                               | Uniform Resource ID, a URL or resource name                                                                                                                                                                                                        |
| **URL**                               | Uniform Resource Locator, an address to an internet resource e.g. http://google.com and is a subset of URIs                                                                                                                                                |
| **UUID**                              | Universal Unique ID, a 128-bit number uniquely identifying an object or entity e.g. dfb7eb64-de7b-4901-a0c4-be3164f7cee4                                                                                                                           |
