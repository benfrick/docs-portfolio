...
# <i class="fas fa-book-open"></i> Reference Guides
    ...
    <div class="ncss-row" style="padding-top:10px;">
        <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
            ...
            <ul class="poc-ul" style="list-style: none;padding:5px;">
                <i style="padding-bottom:5px;" class="g72-training fs32-aligntop pr2-sm d-sm-ib"></i>
                <li class="poc-group-header">
                    <a href="/doc/commerce/reference/caller_best_practices.html">
                    <h4 style="padding-bottom:5px;">Circuit Breaker Best Practices</h4></a></li>
       ...
       <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
            style="width: 180px; height: 180px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin:5px;border-radius:10px;">
           <ul class="poc-ul" style="list-style: none;padding:5px;">
               <i style="padding:5px;" class="g72-flag fs32-aligntop pr2-sm d-sm-ib"></i>
               <li class="poc-group-header">
                   <a href="/doc/commerce/reference/global.html">
                   <h4 style="padding-bottom:5px;">Countries, Channels, Brands</h4></a></li>
               <li style="font-size: 0.8em">List of supported countries, languages, channels and brands.</li>
           </ul>
       </div>        
       <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
            style="width: 180px; height: 180px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin:5px;border-radius:10px;">
           <ul class="poc-ul" style="list-style: none;padding:5px;">
               ...
               <li class="poc-group-header">
                   ...
                   <h4 style="padding-bottom:5px;">Glossary</h4></a></li>
       ...
       <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
            style="width: 180px; height: 180px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin:5px;border-radius:10px;">
           <ul class="poc-ul" style="list-style: none;padding:5px;">
               <i style="padding:5px;" class="g72-triman-recycling fs32-aligntop pr2-sm d-sm-ib"></i>
               <li class="poc-group-header">
                   <a href="/doc/commerce/reference/product_lifecycle.html">
                   <h4 style="padding-bottom:5px;">Product Life Cycle</h4></a></li>
