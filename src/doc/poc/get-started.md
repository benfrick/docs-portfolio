    ...
    <div class="ncss-row">
       <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
           ...
           <ul class="poc-ul" style="list-style: none;padding:5px;">
               <i style="padding:5px;" class="g72-unlock fs32-aligntop pr2-sm d-sm-ib"></i>
               <li class="poc-group-header">
                   <a href="/doc/getting-started/using_nike_apis.html">
                   <h4 style="padding:5px;">Using NDe APIs</h4></a></li>
       ...
       <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
            style="padding:5px;width: 180px; height: 180px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin:5px;border-radius:10px;">
           <ul class="poc-ul" style="list-style: none;padding:5px;">
               <i style="padding:5px;" class="g72-edit fs32-aligntop pr2-sm d-sm-ib"></i>
               <li class="poc-group-header">
                    <a name="api-standards" href="https://confluence.nike.com/display/NEA/API+Standards" target="_blank">
                    <h4 style="padding:5px;">API Standards</h4></a></li>
       ...
       <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
        ...
        <div class="ncss-col-sm-6 full ta-sm-c va-sm-t"
             style="padding:5px;width: 180px; height: 180px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);margin:5px;border-radius:10px;">
            <ul class="poc-ul" style="list-style: none;padding:5px;">
                <i style="padding:5px;" class="g72-training fs32-aligntop pr2-sm d-sm-ib"></i>
                <li class="poc-group-header">
                    <a href="/doc/commerce/reference/caller_best_practices.html">
                    <h4 style="padding:5px;">Circuit Breaker Best Practices</h4></a></li>
                <li style="font-size:0.8em;">Best practices for calling Nike APIs.</li>
            </ul>
       </div>