...
The table below lists the authorization headers required for Edge router requests based on consumer type (Member, Guest, or Employee).
...
><i class="g72-link"></i> [Nike Caching Strategy](https://confluence.nike.com/display/DAHP/Caching+Strategy){:target="new-tab"}

><i class="g72-link"></i> [Akamai Technical Reference](https://confluence.nike.com/display/DAHP/Akamai){:target="new-tab"}
